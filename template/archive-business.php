...
<section class="arc-card-container">
   ...
   <?php  if ($archive_query->have_posts()) : 
        while( $archive_query->have_posts() ) :
            ...
            $status = ($post_status === 'sold' ) ? 'close-btn' : 'open-btn';
            $openclose = ($post_status === 'sold' ) ? __( 'Sold Out', 'startups-market' ) : __( 'Open Now', 'startups-market' );
    ...
    ?>
        ...
        <div class="col container-fluid my-3 mx-">
            <div class="card single-card-container">
                ...
                <!-- card image -->
                <img src="<?php echo esc_url( get_the_post_thumbnail_url( get_the_ID(), 'stm-list-thumbnail' ) ); ?>" class="card-img-top single-card-img <?php esc_attr_e($loggedin); ?>" alt="listing thumbnail">
  ...
  <path d="M9.998 5.083 10 5a2 2 0 1 0-3.132 1.65 6 6 0 0 1 3.13-1.567"/>
                    ...
                    <span><strong><?php esc_html__( 'ARR:', 'startups-market'); ?> </strong>
                ...
                <span><strong><?php esc_html__( 'SARR: ', 'startups-market'); ?> </strong>
