...
<section class=" smt-my-profile-area mb-4 menuItem" id="my-profile-page">
    ...
    <div class=" smt-my-profile row">
        ...
        <!-- form box area -->
        <div class="form-box col-7 border border-1 rounded-1 shadow-sm mb-3 w-auto">
            <form action="" method="POST" id="stm_profile_form" >
                ...
                <div class="full-form-container container-fluid">
                    ...
                    <!-- select a photo -->
                    <div class="select-photo  container-fluid d-flex flex-column align-items-center">
                        <!-- new class added user-image -->
                        <img class="user-image mb-3" src="<?php echo STM_ASSETS; ?>/dashboard/user.svg" alt="">
                        <div class="w-50 d-flex justify-content-center border border-1 py-2 mb-5">
                            <!-- new class added user-input -->
                            <input class="user-input" type="file" name="" id="">
                        </div>
                    </div>
                </div>
                <!-- form save button -->
